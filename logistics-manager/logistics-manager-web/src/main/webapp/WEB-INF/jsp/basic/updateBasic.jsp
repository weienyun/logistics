...
<body>
    ...
    <div class="formbody">
        ...
        <form action="/basic/saveOrUpdate?baseId=${basic.baseId }" method="post">
            <ul class="forminfo">
                <li><label>基础数据</label>
                ...
                <li><label>所属类型</label>
                    ...
                    <div class="vocation">
                        ...
                        <c:forEach items="${parents}" var="parent">
                            <option value="${parent.baseId }" ${basic.parentId eq parent.baseId ?"selected":""}>${parent.baseName }</option>
                        </c:forEach>
                        </select>
                    </div>
                    <i></i>
