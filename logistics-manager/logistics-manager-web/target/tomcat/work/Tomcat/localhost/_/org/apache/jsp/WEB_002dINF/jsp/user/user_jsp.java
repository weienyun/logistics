 ...
 * Generated at: 2019-06-24 04:27:18 UTC
...
public final class user_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<li><a href=\"user/goAddOrUpdate\"><span><img\r\n");
      out.write("\t\t\t\t\t\t\tsrc=\"/images/t01.png\" /></span>添加</a></li>\r\n");
      out.write("\t\t\t\t<li><a href=\"javascript:void()\" onclick=\"updateUser()\"><span><img\r\n");
      out.write("\t\t\t\t\t\t\tsrc=\"/images/t02.png\" /></span>修改</a></li>\r\n");
      out.write("\t\t\t\t<li><a href=\"javascript:void()\" onclick=\"deleteManyUser()\"><span><img \r\n");
      ...
      out.write("\t\t\t\tlocation.href=\"/user/deleteUser?userId=\"+userId;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tfunction updateUser(){\r\n");
      out.write("\t\t\tvar arr = new Array();\r\n");
      out.write("\t\t\t$(\"#userId :checkbox[checked]\").each(function(i){\r\n");
      out.write("\t\t\t\t\tarr[i] = $(this).val();\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\tif (arr.length==1) {\r\n");
      out.write("\t\t\t\tlocation.href=\"/user/goAddOrUpdate?userId=\"+arr[0];\r\n");
      out.write("\t\t\t}else {\r\n");
      out.write("\t\t\t\talert(\"需要选择一个要修改的用户\");\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tfunction deleteManyUser(){\r\n");
      out.write("\t\t\tvar arr = new Array();\r\n");
      out.write("\t\t\t$(\"#userId :checkbox[checked]\").each(function(i){\r\n");
      out.write("\t\t\t\tarr[i]=$(this).val();\r\n");
      out.write("\t\t\t})\r\n");
      out.write("\t\t\tif(arr.length>0){\r\n");
      out.write("\t\t\t\tlocation.href=\"/user/deleteUser?userId=\"+arr;\r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\talert(\"请选中至少一个修改的！\");\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      out.write("\t</script>\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/user/user.jsp(68,4) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/jsp/user/user.jsp(68,4) '${pageModel.list}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${pageModel.list}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    // /WEB-INF/jsp/user/user.jsp(68,4) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("</td>\r\n");
          out.write("\t\t\t\t\t\t<td><a\r\n");
          out.write("\t\t\t\t\t\t\thref=\"user/goAddOrUpdate?select=1&userId=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${user.userId}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("\"\r\n");
          out.write("\t\t\t\t\t\t\tclass=\"tablelink\">查看</a> <a href=\"javascript:void()\"\r\n");
